<?php
/**
 * GUIDE - DANH SÁCH CHECKPOINTS CỦA SCHEDULE
...
<div class="max-w-6xl mx-auto p-4 lg:p-8">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4 lg:mb-6">
        ...
        <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
            ...
            <a href="?act=guide-tours&action=show&id=<?= $schedule['id'] ?>&tab=checkin" 
    ...
    <?php if (empty($checkpoints)): ?>
        <div class="bg-panel rounded-2xl p-8 lg:p-12 text-center border border-primary-100">
            ...
            <p class="text-sm lg:text-base text-primary-500 mb-6">Tạo checkpoint để bắt đầu check-in</p>
                ...
                <div class="bg-panel rounded-2xl overflow-hidden border border-primary-100 shadow-sm hover:shadow-md transition-shadow">
                    <div class="p-4 lg:p-5">
                        ...
                        <a href="?act=guide-activity-checkin&action=show&checkpoint_id=<?= $cp['id'] ?>" 
                            class="w-full px-3 lg:px-4 py-2 lg:py-2.5 bg-gradient-to-r from-accent-gradient-from to-accent-gradient-to hover:opacity-90 text-white rounded-xl text-xs lg:text-sm font-semibold transition-all flex items-center justify-center gap-2">
