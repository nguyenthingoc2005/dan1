...
<div class="max-w-5xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 lg:gap-3 mb-4 lg:mb-6">
        ...
        <a href="?act=staff-tours&action=selectTemplate" class="text-primary-500 hover:text-accent font-semibold flex items-center gap-2 text-xs lg:text-sm transition-colors">
    ...
    <form method="POST" action="?act=staff-tours&action=store" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row justify-end gap-2 lg:gap-3">
            <a href="?act=staff-tours&action=selectTemplate" class="w-full sm:w-auto px-4 lg:px-6 py-2 lg:py-2.5 bg-primary-50 text-primary-700 rounded-xl font-semibold hover:bg-primary-100 transition-colors text-sm lg:text-base text-center">
                Hủy
            </a>
