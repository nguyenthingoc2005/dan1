...
<div class="max-w-[95%] mx-auto">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4 lg:mb-6">
        ...
        <div class="flex gap-2 w-full sm:w-auto">
            <a href="?act=staff-bookings" class="w-full sm:w-auto px-4 lg:px-5 py-2 lg:py-2.5 bg-panel border border-primary-100 text-primary-700 rounded-xl hover:bg-primary-50 font-semibold transition-all text-sm lg:text-base text-center flex items-center justify-center gap-2">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <!-- PAYMENT LIST -->
            <div class="bg-panel p-4 lg:p-6 rounded-2xl shadow-sm border border-primary-100">
                <h2 class="text-base lg:text-lg font-bold text-primary-700 border-b border-primary-100 pb-2 lg:pb-3 mb-4 lg:mb-5">Lịch sử giao dịch</h2>
