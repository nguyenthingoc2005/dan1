<div class=" mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
                    ...
                    <div class="p-4 lg:p-5 flex-1">
                        ...
                        <div class="flex flex-wrap items-center gap-2 text-xs text-primary-500 mb-3">
                            <span class="flex items-center gap-1 bg-primary-100 px-2 lg:px-3 py-1 rounded-full">
                                ...
                                <span
                                    class="truncate max-w-[120px] lg:max-w-[150px]"><?= htmlspecialchars($journal['tour_name']) ?></span>
                            </span>
                            <span class="flex items-center gap-1 bg-primary-100 px-2 lg:px-3 py-1 rounded-full">
        ...
        <?php else: ?>
            <div
                class="col-span-full py-8 lg:py-12 text-center bg-panel rounded-2xl border border-primary-100 border-dashed">
                <div class="flex flex-col items-center justify-center">
                    ...
                    <p class="text-sm text-primary-500">Chỉ hiển thị nhật ký của các tour đã hoàn thành hoặc đang diễn ra.
                    </p>
                </div>
            </div>
        <?php endif; ?>
