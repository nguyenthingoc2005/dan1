...
<div class="mb-4 lg:mb-6">
    <div class="flex flex-wrap items-center gap-2 text-xs lg:text-sm text-primary-500 mb-2 lg:mb-3">
        ...
        <span>/</span>
        <a href="?act=admin&module=location-services&country_id=<?= $country['id'] ?>" class="hover:text-accent font-semibold">
            <?= htmlspecialchars($country['name']) ?>
        </a>
        <span>/</span>
        <span class="text-primary-700 font-semibold">Sửa</span>
    </div>
...
<div class="bg-panel p-4 lg:p-6 rounded-2xl border-l-4 border-accent shadow-sm">
    <form method="POST" action="?act=admin&module=location-services&action=update-country" class="space-y-4 lg:space-y-6">
        ...
        <div>
            ...
            <div class="mb-3 lg:mb-4">
                <label class="block text-xs lg:text-sm font-semibold text-primary-700 mb-1 lg:mb-2">Mã quốc gia</label>
                ...
                <p class="text-xs text-primary-500 mt-1">Mã quốc gia không thể thay đổi sau khi tạo</p>
            </div>
