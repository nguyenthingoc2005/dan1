...
<div class="mb-4 lg:mb-6">
    <div class="flex flex-wrap items-center gap-2 text-xs lg:text-sm text-primary-500 mb-2 lg:mb-3">
        ...
        <span>/</span>
        <span class="text-primary-700 font-semibold">Thêm nhà dịch vụ</span>
    </div>
...
<div class="bg-panel p-4 lg:p-6 rounded-2xl border-l-4 border-accent shadow-sm">
    <div class="mb-4 lg:mb-6 p-3 lg:p-4 bg-info-bg border-l-4 border-info rounded-xl text-xs lg:text-sm">
