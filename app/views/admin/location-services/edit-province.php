    ...
    <form method="POST" action="?act=admin&module=location-services&action=update-province" class="space-y-6">
        ...
        <div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name_en" value="<?= htmlspecialchars($province['name_en'] ?? '') ?>"
                    class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <div>
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="number" name="display_order" value="<?= htmlspecialchars($province['display_order'] ?? 0) ?>"
                        class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                        min="0">
                ...
                <div>
                    ...
                    <select name="status"
                        ...
                        <option value="inactive" <?= $province['status'] == 'inactive' ? 'selected' : '' ?>>Ngừng hoạt động</option>
                    </select>
                </div>
            </div>
        </div>
