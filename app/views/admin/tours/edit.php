...
<div class="max-w-6xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4 lg:mb-6">
        ...
        <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
            <a href="?act=admin&module=tours&action=show&id=<?= $tour['id'] ?>" class="w-full sm:w-auto px-4 lg:px-5 py-2 lg:py-2.5 bg-panel border border-primary-100 text-primary-700 rounded-xl hover:bg-primary-50 font-semibold transition-all text-sm lg:text-base text-center flex items-center justify-center gap-2">
                <i data-lucide="eye" class="w-4 h-4"></i>
                Xem chi tiết
            </a>
            <a href="?act=admin&module=tours" class="w-full sm:w-auto px-4 lg:px-5 py-2 lg:py-2.5 bg-panel border border-primary-100 text-primary-700 rounded-xl hover:bg-primary-50 font-semibold transition-all text-sm lg:text-base text-center flex items-center justify-center gap-2">
    ...
    <form method="POST" action="?act=admin&module=tours&action=update" enctype="multipart/form-data" class="space-y-4 lg:space-y-6">
        ...
        <div class="bg-panel rounded-2xl shadow-sm border border-primary-100 overflow-hidden">
            ...
            <div class="p-4 lg:p-5">
                ...
                <div class="mt-4 lg:mt-5 p-4 lg:p-5 bg-warning-bg rounded-2xl border border-warning">
                    <h4 class="font-semibold text-warning-text mb-3 text-sm lg:text-base flex items-center gap-2">
                        <i data-lucide="dollar-sign" class="w-4 h-4"></i>
                        Chi phí cố định (chia đều cho số người)
                    </h4>
                    <p class="text-xs lg:text-sm text-warning-text mb-4">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="fixed_cost_guide" id="fixed_cost_guide" min="0" step="10000"
                                ...
                                class="w-full px-3 lg:px-4 py-2 lg:py-2.5 bg-white border border-primary-100 rounded-xl focus:outline-none focus:border-warning transition-all placeholder:text-primary-300 text-primary-700 text-sm lg:text-base" placeholder="VD: 2000000">
                        </div>
                        <div>
                            <label class="block text-xs lg:text-sm font-semibold text-primary-700 mb-1 lg:mb-2">
                                Chi phí quản lý
                            ...
                            <input type="number" name="fixed_cost_management" id="fixed_cost_management" min="0"
                                ...
                                class="w-full px-3 lg:px-4 py-2 lg:py-2.5 bg-white border border-primary-100 rounded-xl focus:outline-none focus:border-warning transition-all placeholder:text-primary-300 text-primary-700 text-sm lg:text-base" placeholder="VD: 1500000">
                        </div>
                        <div>
                            <label class="block text-xs lg:text-sm font-semibold text-primary-700 mb-1 lg:mb-2">
                                Chi phí marketing
                            ...
                            <input type="number" name="fixed_cost_marketing" id="fixed_cost_marketing" min="0"
                                ...
                                class="w-full px-3 lg:px-4 py-2 lg:py-2.5 bg-white border border-primary-100 rounded-xl focus:outline-none focus:border-warning transition-all placeholder:text-primary-300 text-primary-700 text-sm lg:text-base" placeholder="VD: 500000">
                        </div>
                        <div>
                            <label class="block text-xs lg:text-sm font-semibold text-primary-700 mb-1 lg:mb-2">
                                Chi phí khác
                            ...
                            <input type="number" name="fixed_cost_other" id="fixed_cost_other" min="0" step="10000"
                                ...
                                class="w-full px-3 lg:px-4 py-2 lg:py-2.5 bg-white border border-primary-100 rounded-xl focus:outline-none focus:border-warning transition-all placeholder:text-primary-300 text-primary-700 text-sm lg:text-base" placeholder="VD: 0">
                        </div>
                    </div>
                    <div class="mt-4 p-3 lg:p-4 bg-warning-bg/50 rounded-xl border border-warning text-xs lg:text-sm text-warning-text">
        ...
        <div class="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t border-primary-100">
            <a href="?act=admin&module=tours&action=show&id=<?= $tour['id'] ?>" class="w-full sm:w-auto px-4 lg:px-6 py-2 lg:py-2.5 bg-panel border border-primary-100 text-primary-700 rounded-xl hover:bg-primary-50 font-semibold transition-all text-sm lg:text-base text-center">
                Hủy
            </a>
