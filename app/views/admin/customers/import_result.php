...
<div class="max-w-6xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-primary">Kết quả Import</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
        <div class="p-6 border-b border-gray-100">
            <h2 class="text-lg font-semibold text-gray-800">Thông tin Import</h2>
        </div>
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="text-center p-4 bg-gray-50 rounded-lg">
                    ...
                    <div class="text-sm text-gray-600 mt-1">Bỏ qua (trùng)</div>
                </div>
            </div>
            ...
            <div class="mt-6 pt-6 border-t border-gray-100">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                        <span class="text-gray-600">Người import:</span>
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        <div class="p-6 border-b border-gray-100">
            <h2 class="text-lg font-semibold text-gray-800">Chi tiết lỗi</h2>
            <p class="text-sm text-gray-500 mt-1">Các dòng có lỗi trong quá trình import</p>
        </div>
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Dòng</th>
