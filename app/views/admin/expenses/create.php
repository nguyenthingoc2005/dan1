...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-8">
    ...
    <div class="mb-4 lg:mb-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h1 class="text-xl lg:text-2xl font-bold text-primary-700">Thêm chi phí phát sinh</h1>
    ...
    <form method="POST" action="?act=admin&module=expenses&action=store" enctype="multipart/form-data" class="bg-panel rounded-2xl p-4 lg:p-6 border border-primary-100 shadow-sm">
        <?= csrf_field() ?>
        <input type="hidden" name="schedule_id" value="<?= $schedule['id'] ?>">

        <div class="space-y-4 lg:space-y-6">
            <!-- Booking Selection (Optional for admin) -->
            <div>
            ...
            <div class="flex items-center gap-2">
                ...
                <label for="auto_approve" class="text-sm text-primary-700">
                    Tự động duyệt chi phí này
                </label>
            </div>
