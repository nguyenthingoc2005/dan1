<?php
/**
 * ADMIN LAYOUT - Layout cho Admin
 * Sử dụng: require VIEWS_PATH . '/layouts/admin_layout.php';
 */
    ...
    <div class="flex h-screen bg-main overflow-hidden">
        ...
        <div class="w-72 bg-primary text-white flex flex-col transition-all duration-300 shadow-xl z-20 relative">
            ...
            <div class="p-6 border-b border-slate-700 flex items-center justify-between bg-slate-900/50">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-slate-400 text-xs uppercase tracking-wider font-medium">Admin Panel</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-4 border-t border-slate-700 bg-slate-800/50">
                <div class="flex items-center gap-3 mb-4">
                    <div class="w-10 h-10 rounded-full bg-accent flex items-center justify-center text-white font-bold shadow-lg ring-2 ring-white/20">
        ...
        <div class="flex-1 flex flex-col overflow-hidden bg-slate-50 relative">
            ...
            <header class="bg-white border-b border-slate-200 px-8 py-4 flex justify-between items-center shadow-sm z-10">
                ...
                <div class="flex items-center gap-4">
                    <button class="p-2 text-slate-400 hover:text-slate-600 transition-colors relative rounded-full hover:bg-slate-100">
            ...
            <main class="flex-1 overflow-y-auto p-8 custom-scrollbar">
                <div class="max-w-7xl mx-auto">
                    <?php if ($error = get_error()): ?>
                        <div class="mb-6 p-4 bg-red-50 border-l-4 border-red-500 rounded-r-lg flex items-center gap-3 shadow-sm animate-fade-in">
                    ...
                    <?php if ($success = get_success()): ?>
                        <div class="mb-6 p-4 bg-green-50 border-l-4 border-green-500 rounded-r-lg flex items-center gap-3 shadow-sm animate-fade-in">
