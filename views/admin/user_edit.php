...
<head>
    ...
    <style>
        ...
        .form-control:focus, .form-select:focus {
            border-color: #ffc107; box-shadow: 0 0 0 0.25rem rgba(255, 193, 7, 0.25); /* Màu vàng cho Edit */
        }
    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h3 class="fw-bold text-dark mb-1">Cập Nhật Người Dùng</h3>
                    <p class="text-muted mb-0">Chỉnh sửa thông tin tài khoản #<?= htmlspecialchars($user['nguoi_dung_id']) ?></p>
                </div>
                    ...
                    <div class="card card-custom p-4">
                        <form action="index.php?act=user_update" method="POST">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div class="section-title"><i class="bi bi-shield-lock me-2"></i>Thông tin Tài khoản</div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" id="vai_tro_id" name="vai_tro_id" required>
                                                ...
                                                <?php foreach($roles as $r): ?>
                                                    <option value="<?= $r['vai_tro_id'] ?>" 
                                                        <?= $r['vai_tro_id'] == $user['vai_tro_id'] ? 'selected' : '' ?>>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" id="trang_thai" name="trang_thai">
                                                <option value="active" <?= (isset($user['trang_thai']) && $user['trang_thai'] == 'active') ? 'selected' : '' ?>>Hoạt động (Active)</option>
                                                <option value="inactive" <?= (isset($user['trang_thai']) && $user['trang_thai'] == 'inactive') ? 'selected' : '' ?>>Khóa (Inactive)</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control fw-bold text-dark" id="ho_ten" name="ho_ten" 
