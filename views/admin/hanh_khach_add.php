    ...
    <div class="main-content">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h3 class="fw-bold text-dark mb-1">Nhập Thông Tin Hành Khách</h3>
                    ...
                    <div class="card card-custom p-4">
                        ...
                        <form action="<?= BASEURL ?>?act=hanh_khach_save&dat_tour_id=<?= htmlspecialchars($data['dat_tour_id']) ?>" method="POST">
                            ...
                            <div class="accordion" id="accordionPassengers">
                                ...
                                // Vòng lặp tạo form nhập liệu cho từng khách
                                for ($i = 0; $i < $so_luong_nguoi; $i++): 
                                    $stt = $i + 1;
                                    // Mở sẵn người đầu tiên
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading<?= $i ?>">
                                        <button class="accordion-button <?= ($i === 0) ? '' : 'collapsed' ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?= $i ?>" aria-expanded="<?= $is_expanded ?>" aria-controls="collapse<?= $i ?>">
                                            ...
                                            <span class="fw-bold name-display-<?= $i ?>">Hành khách #<?= $stt ?></span>
                                        </button>
                                    </h2>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea class="form-control input-icon-control" rows="2"
                                                                  ...
                                                                  placeholder="Ví dụ: Ăn chay, dị ứng, cần hỗ trợ xe lăn..."></textarea>
                                                    </div>
                                                </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <button type="submit" class="btn btn-success px-4 fw-bold shadow-sm">
                                        <i class="bi bi-arrow-right-circle me-2"></i> Lưu & Tiếp tục (Đặt cọc)
                                    </button>
                                </div>
                            </div>
