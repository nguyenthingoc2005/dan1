...
<head>
    ...
    <style>
        ...
        .section-title { font-size: 1.1rem; font-weight: 700; color: #0d6efd; border-bottom: 2px solid #f0f0f0; padding-bottom: 10px; margin-bottom: 20px; margin-top: 10px; }

        /* Avatar Placeholder */
        .img-preview-container { width: 150px; height: 150px; border-radius: 50%; border: 4px solid #fff; box-shadow: 0 0 10px rgba(0,0,0,0.1); overflow: hidden; margin: 0 auto 15px; background: #e7f1ff; display: flex; align-items: center; justify-content: center; position: relative; color: #0d6efd; font-size: 3rem; font-weight: bold; }
    </style>
</head>
<body>
